...
We make a lot of maps at the Los Angeles Times. So we made this tool to help us make them faster. It uses Tangram, which was developed by Mapzen (and tiles are now hosted by (Nextzen)[https://www.nextzen.org/]). The map uses Natural Earth and OpenStreetMap data to export an image or a vector file.
